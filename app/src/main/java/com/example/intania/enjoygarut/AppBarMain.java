...
public class AppBarMain extends AppCompatActivity {
    ...
    private void prepareDestinations() {
        int[] covers = new int[]{
                ...
                R.drawable.destination3,
                R.drawable.destination4,
               };
        ...
        a = new Destination("Honeymoon", 14, covers[4]);
        destList.add(a);

        a = new Destination("I Need a Doctor", 1, covers[5]);
        destList.add(a);

        a = new Destination("Loud", 11, covers[6]);
        destList.add(a);

        a = new Destination("Legend", 14, covers[7]);
        destList.add(a);

        a = new Destination("Hello", 11, covers[8]);
        destList.add(a);

        a = new Destination("Greatest Hits", 17, covers[9]);
        destList.add(a);
